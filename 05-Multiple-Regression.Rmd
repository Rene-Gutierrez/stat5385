...
2. $\bH$ is symmetric semi-positive definite.
3. All the eigenvalues of $\bH$ are either 0 or 1.
...
Now let us see that $\bH$ is symmetric semi-positive definite. Pick $z \in \dR^n$.
