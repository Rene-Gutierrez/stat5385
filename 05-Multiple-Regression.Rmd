...
$$
\min_{\boldsymbol{\beta}} \sum_{i=1}^n (y_i - \mathbf{x}*i'\boldsymbol{\beta})^2 + \lambda \sum*{j=1}^n \beta_j^2
...
$$
\min_{\boldsymbol{\beta}} \sum_{i=1}^n (y_i - \mathbf{x}*i'\boldsymbol{\beta})^2 + \lambda \sum*{j=1}^n |\beta_j|
