...
$$ SS_{reg} = \sumin (\hy_i - \bar{y}) = \sumin (\hy_i - \hat{\bar{y}})^2 $$
```
...
If $SS_{tot}>0$, the Coefficient of Determmination is given by:
  $$ R^2 = \frac{SS_{reg}}{SS_{tot}} $$
```

```{proposition, prp-coefficient-of-determmination, name = "Alternate Definition of the Coefficient of Determmination"}
If $SS_{tot}>0$, the Coefficient of Determmination can be defined alternatively as:
